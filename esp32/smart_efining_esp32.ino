...
// Wi-Fi credentials — configured for Software Lab2.
...
// Debug test coordinates (Padma Bridge Expressway area).
#define DEBUG_LAT      23.4721
#define DEBUG_LNG      90.2814
#define DEBUG_SPEED    72.0
